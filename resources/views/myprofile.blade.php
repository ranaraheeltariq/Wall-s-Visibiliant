                  	...
                  	<div class="d-flex justify-content-between">
                        ...
                        <div class="py-4">
                          ...
                          <p class="clearfix">
                            ...
                            <span class="float-right text-muted"> {{ Auth::user()->designation }} </span>
                          </p>
                          ...
                          @endisset
                          @isset(Auth::user()->region_id)
                          <p class="clearfix">
                            <span class="float-left"> Region </span>
                            <span class="float-right text-muted"> {{ Auth::user()->region->name }} </span>
                          </p>
                          @endisset
                          @isset(Auth::user()->conc_id)
                          <p class="clearfix">
                            <span class="float-left"> Conc </span>
                            <span class="float-right text-muted"> {{ Auth::user()->conc->name }} </span>
                          </p>
                          @endisset
                          @isset(Auth::user()->territory_id)
                          <p class="clearfix">
                            <span class="float-left"> Territory </span>
                            <span class="float-right text-muted"> {{ Auth::user()->territory->name }} </span>
                          </p>
                          @endisset
                          <p class="clearfix">
