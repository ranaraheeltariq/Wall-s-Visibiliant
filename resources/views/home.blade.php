                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <div class="form-group">
                                    <select class="js-example-basic-single form-control" name="territory_id">
                                      ...
                                      @foreach(App\Models\Territory::whereIn('id',$data)->get() as $teritory)
                              ...
                              <div class="col-md-8">
                                <div class="input-group input-daterange d-flex align-items-center">
                                  <input type="text" name="from" class="form-control" data-date-format='yyyy-mm-dd' value="2012-04-05">
                                  <div class="input-group-addon mx-4">to</div>
                                  <input type="text" name="to" class="form-control" data-date-format='yyyy-mm-dd' value="2012-04-19">
                                </div>
                              </div>
                            </div>
